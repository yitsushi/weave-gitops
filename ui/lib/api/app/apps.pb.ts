...
export class Apps {
  ...
  static RemoveKustomizations(req: Gitops_serverV1Kustomize.RemoveKustomizationReq, initReq?: fm.InitReq): Promise<Gitops_serverV1Kustomize.RemoveKustomizationRes> {
    return fm.fetchReq<Gitops_serverV1Kustomize.RemoveKustomizationReq, Gitops_serverV1Kustomize.RemoveKustomizationRes>(`/v1/namespace/${req["namespace"]}/app/${req["appName"]}/kustomization/${req["kustomizationName"]}`, {...initReq, method: "DELETE"})
  }
