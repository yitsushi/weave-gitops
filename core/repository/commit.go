...
func NewGitWriter(push bool) Committer {
	return &gitCommitter{
		push:   push,
		remove: false,
	}
...
func NewGitDeleter(push bool) Committer {
	return &gitCommitter{
		push:   push,
		remove: true,
	}
...
func (g gitCommitter) Commit(repo *git.Repository, auth transport.AuthMethod, msg string, files []File) (string, error) {
